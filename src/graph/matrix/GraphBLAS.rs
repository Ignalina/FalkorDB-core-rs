...
// bindgen --allowlist-file deps/GraphBLAS/Include/GraphBLAS.h deps/GraphBLAS/Include/GraphBLAS.h --default-enum-style=rust -o deps/FalkorDB-core-rs/src/graph/matrix/GraphBLAS.rs
